...
DEBUG = True
#DEBUG=False
#ADMINS=[('Malijai', 'malijai.caulet@videotron.ca'), ]

ALLOWED_HOSTS = ['localhost', '127.0.0.1','santementalejustice.ca']
...
#LOGIN_REDIRECT_URL = '/mbntp/'
#LOGIN_URI = '/mbntp/login/'
...
#EMAIL_HOST = 'mail.santementalejustice.ca'
#EMAIL_HOST_PASSWORD = 'LRxC38pQKKce'
#EMAIL_HOST_USER = 'malijai.caulet@santementalejustice.ca'
#EMAIL_PORT = ''
#DEFAULT_FROM_EMAIL = 'malijai.caulet@santementalejustice.ca'
